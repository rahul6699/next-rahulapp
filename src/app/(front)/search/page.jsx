                                ...
                                <div className="lg:px-4 px-3 lg:pb-3 pb-3  lg:pt-5 pt-2">
                                    <form className="">
                                        <div className="grid grid-cols-12 mb-4 items-center  ">
                                            <Label for="horizontal-company-name-input" className="col-span-12 lg:col-span-5 font-bold text-sm  text-[#221F20] dark:text-zinc-100" name="Company Name" />
                                        ...
                                        <div className="grid grid-cols-12 mb-4 items-center  ">
                                            <Label for="horizontal-email-input" className="col-span-12 lg:col-span-4 font-bold text-sm text-[#221F20] dark:text-zinc-100" name="Category" />
                                        ...
                                        <div className="grid grid-cols-12 mb-4 items-center  ">
                                            <Label for="horizontal-zip-code-input" className="col-span-12 lg:col-span-4 font-bold text-sm text-[#221F20] dark:text-zinc-100" name="Zip Code" />
                                            <div className="col-span-12 lg:col-span-8">
                                        ...
                                        <div className="mb-1">
                                            <Label className="block font-bold text-sm text-[#221F20] dark:text-gray-100 mb-2" for="customRange1" name="Proximity to Zip" />
